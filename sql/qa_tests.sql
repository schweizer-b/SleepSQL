...
SELECT
  p.patients_code
FROM patients p
LEFT JOIN recordings r ON r.patients_id = p.patients_id
...
SELECT 'epochs_total' AS metric, COUNT(*) AS value FROM epochs
UNION ALL
SELECT 'epochs_sleep', COUNT(*) FROM epochs WHERE stage_label IN ('N1','N2','N3','REM')
UNION ALL
SELECT 'epochs_wake', COUNT(*) FROM epochs WHERE stage_label='W'
UNION ALL
SELECT 'unknown_epochs', COUNT(*) FROM epochs WHERE stage_label='UNKNOWN';
